...
\documentclass[9pt]{./packages/Developer_CV/developercv}
\usepackage{amssymb}
...
\begin{minipage}[t]{0.15\textwidth} % 30% of the page width for photo
    ...
    \ifpdf
        \fbox{\includegraphics[width=\linewidth]{photo_square.jpg}}
    \else
        \fbox{\includegraphics[width=\linewidth,natwidth=810,natheight=810]{photo_square.jpg}}
    \fi
\end{minipage}
...
\begin{entrylist}
    ...
    {
    Working as part of a 5-person team Embedded Systems team, I gained hands-on experience across various software engineering areas, including DevOps, code development, and conducting product research. The role also offered opportunities to contribute to collaborative projects while further enhancing my technical expertise.
    \begin{enumerate}
        \raggedright
        \item[$\blacksquare$] Development of custom Linux distributions and firmware for embedded applications using Yocto/Buildroot/OpenWRT.
        \begin{enumerate}
    ...
    \entry
        ...
        \begin{enumerate}
            ...
            \end{enumerate}
            \item[$\blacksquare$] Collaborated on a QR/Datamatrix reading scanner in C++ and STM32.
        \end{enumerate}
        }
    \end{entrylist}
