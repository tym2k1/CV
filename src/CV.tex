...
\begin{minipage}[t]{0.60\textwidth} % 45% of the page width for the introduction text
    ...
    exploring algorithmic music and design, when time allows.
...
\begin{entrylist}
    ...
    \begin{enumerate}
        \item[$\blacksquare$] Implemented a Zero-Knowledge PUF-based authentication trusted service on a static-partitioning hypervisor (Bao/CROSSCON Hypervisor) for Arm Cortex-M (LPC55S69), using Zephyr RTOS as isolated "VMs". Delivered a proof-of-concept demonstrating potential GlobalPlatform compliance on this architecture.
    \end{enumerate}
